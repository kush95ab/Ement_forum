...
export class AuthenticationService {
  ...
  getLoggingUser(authData: Auth) {
    ...
    .subscribe(
      ...
      (err) => alert('Error occured..getLoggingUser Contact Administrations!')
    );
  }
  ...
  loginUser(authData: Auth) {
    ...
    .subscribe(
      ...
      (err) => alert('Error occured..loginUser Contact Administrations!')
    );
  }
  ...
  setLoggedUserObject() {
    ...
    .subscribe(
      ...
      (err) => alert('Error occured.. setLoggedUserObject Contact Administrations!')
    );
  }
