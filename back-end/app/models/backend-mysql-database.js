...
DatabaseMySql.prototype.insertUser = function (user, callback) {
  ...
  connection.beginTransaction(function (err) {
    ...
    connection.query(sqlUser, function (err, result) {
      if (err) {
        console.log("error in conn.query");
        console.log(err);
        connection.rollback();
        callback(null, err);
      } else {
...
DatabaseMySql.prototype.updateUser = function (user, callback) {
  ...
  connection.beginTransaction(function (err) {
    ...
    /* -- Start update User -- */
    connection.query(sqlUpdateUser, function (err, result) {
      if (err) {
        connection.rollback();
        callback(null, err);
      } else {
  ...
  connection.beginTransaction(function (err) {
    ...
    connection.query(sqlInsertStudent, function (result, err) {
      if (err) {
        ...
        callback(result);// tempory testing
      }
    });
  });
}
...
DatabaseMySql.prototype.insertMentor = function (mentor, callback) {
  ...
  connection.beginTransaction(function (err) {
    ...
    /* -- Start insert Mentor -- */
    connection.query(sqlInsertMentor, function (result, err) {
      if (err) {
        connection.rollback();
        callback(null, err);
      } else {
...
DatabaseMySql.prototype.updateMentor = function (mentor, callback) {
  ...
  connection.beginTransaction(function (err) {
    ...
    /* -- Start update Mentor -- */
    connection.query(sqlUpdateMentor, function (result, err) {
      if (err) {
        connection.rollback();
        callback(null, err);
      } else {
...
DatabaseMySql.prototype.insertCompany = function (company, callback) {
  ...
  connection.beginTransaction(function (err) {
    ...
    connection.query(sqlInsertCompany, function (result, err) {
      if (err) {
        connection.rollback();
        callback(null, err);
      } else {
...
DatabaseMySql.prototype.updateCompany = function (company, callback) {
  ...
  connection.beginTransaction(function (err) {
    ...
    connection.query(sqlUpdateCompany, function (result, err) {
      if (err) {
        connection.rollback();
        callback(null, err);
      } else {
...
DatabaseMySql.prototype.insertMilestone = function (milestone, callback) {
  ...
  connection.beginTransaction(function (err) {
    ...
    connection.query(sqlInsertMilestone, function (result, err) {
      if (err) {
        connection.rollback();
        callback(null, err);
      } else {
...
DatabaseMySql.prototype.updateMilestone = function (milestone, callback) {
  ...
  connection.beginTransaction(function (err) {
    ...
    connection.query(sqlUpdateMilestone, function (result, err) {
      if (err) {
        connection.rollback();
        callback(null, err);
      } else {
...
DatabaseMySql.prototype.insertProject = function (project, callback) {
  ...
  connection.beginTransaction(function (err) {
    ...
    connection.query(sqlInsertProject, function (result, err) {
      if (err) {
        connection.rollback();
        callback(null, err);
      } else {
...
DatabaseMySql.prototype.updateProject = function (project, callback) {
  ...
  connection.beginTransaction(function (err) {
    ...
    connection.query(sqlUpdateProject, function (result, err) {
      if (err) {
        connection.rollback();
        callback(null, err);
      } else {
...
DatabaseMySql.prototype.insertProjectIdea = function (projectIdea, callback) {
  ...
  connection.beginTransaction(function (err) {
    ...
    connection.query(sqlInsertProjectIdea, function (result, err) {
      if (err) {
        connection.rollback();
        callback(null, err);
      } else {
...
DatabaseMySql.prototype.updateProjectIdea = function (projectIdea, callback) {
  ...
  connection.beginTransaction(function (err) {
    ...
    connection.query(sqlUpdateProjectIdea, function (result, err) {
      if (err) {
        connection.rollback();
        callback(null, err);
      } else {
...
DatabaseMySql.prototype.insertSkill = function (task, callback) {
  ...
  connection.beginTransaction(function (err) {
    ...
    /* -- Start insert Task -- */
    connection.query(sqlInsertTask, function (result, err) {
      if (err) {
        connection.rollback();
        callback(null, err);
      } else {
...
DatabaseMySql.prototype.updateTask = function (task, callback) {
  ...
  connection.beginTransaction(function (err) {
    ...
    /* -- Start update Task -- */
    connection.query(sqlUpdateTask, function (result, err) {
      if (err) {
        connection.rollback();
        callback(null, err);
      } else {
