...
Utils.prototype.sqlqueryInsertPost = function (Post) {
    ...
    var sqlInsertPost = "INSERT INTO posts (post_id,post_author,post_title,post_body,user_type,post_category) VALUES (" +
        "NULL," +
        "'" + Post.postAuthor + "'," +
        "'" + Post.postTitle + "'," + 
        "'" + Post.postBody + "'," +
...
Utils.prototype.updatePost = function (Post) {
    var sqlUpdatePost = "UPDATE posts SET " +
        ...
        "upvote=" + Post.postUpvote + "," +
        "downvote=" + Post.postDownvote + "," +
...
Utils.prototype.getSqlUpdateReply = function (Reply) {
    var sqlUpdateReply = "UPDATE postsreply SET " +
        "reply_body='" + Reply.replyBody + "'," +
        "upvote=" + Reply.replyUpvote + "," +
        "downvote=" + Reply.replyDownvote + "' WHERE " +
...
Utils.prototype.generatepostReply = function (resultpostReply) {
    ...
    if (resultpostReply) {
        postReply = new Reply(
            ...
            resultpostReply.upvote,
            resultpostReply.downvote);
    }
    return postReply;
};
